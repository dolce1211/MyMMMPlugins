...
namespace Linearstar.Keystone.IO.MikuMikuDance
{
    ...
    public class VmdDocument
    {
        ...
        private static IEnumerable<VmdBoneFrame> ReadBoneFrames(BinaryReader br)
        {
        ...
        private static IEnumerable<VmdMorphFrame> ReadMorphFrames(BinaryReader br)
        {
            var count = br.ReadUInt32();
        ...
        private static IEnumerable<VmdCameraFrame> ReadCameraFrames(BinaryReader br, VmdVersion version)
        {
            var count = br.ReadUInt32();
        ...
        private static IEnumerable<VmdLightFrame> ReadLightFrames(BinaryReader br)
        {
            var count = br.ReadUInt32();
        ...
        private static IEnumerable<VmdSelfShadowFrame> ReadSelfShadowFrames(BinaryReader br)
        {
            var count = br.ReadUInt32();
